...
pub struct PlayerLineupCompBin {
    ...
    pub buffs: ::prost::alloc::vec::Vec<LineupBuff>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct GroupBin {
    #[prost(message, repeated, tag = "1")]
    pub prop_list: ::prost::alloc::vec::Vec<PropBin>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SceneBin {
    ...
    pub group_map: ::std::collections::HashMap<u32, GroupBin>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
